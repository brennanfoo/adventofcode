var input = `dark maroon bags contain 2 striped silver bags, 4 mirrored maroon bags, 5 shiny gold bags, 1 dotted gold bag.
...
vibrant olive bags contain 3 muted turquoise bags, 5 wavy blue bags, 1 dotted silver bag, 5 striped tan bags.`.split('\n');

// Ignore all numbers
// Ignore all bags/lines that "contain no other bags".
// var input
...
// Figure out the names of every bag. Names are always 2 words long.
input.forEach(function (i){
    var wordsArray = i.split(' ');
    colors.push(wordsArray[0] + " " + wordsArray[1]);
    for (i=0;i<(wordsArray.length)/5-
})
console.log(colors);

// Figure out which bags have any # of shiny gold bags inside them.
var shinyGold = [];
